...
_form.createIfNotExists(
	_val.map()
		...
		.set("export_xml", true)
		.set("firebase", "")
		.set("name", "case_sector")
		.set("parent_uid", "c7b40b42-b550-4072-8c89-9f6b639e861f")
		.set("reorder", 0)
		.set("report", false)
		.set("report_behaviour", 0)
		.set("show_id", true)
		.set("title", "Sector")
		.set("uid", "4dfa2e07-69db-451e-9807-d8aa3b224398")
);
_form.createComponentIfNotExists(
	"4dfa2e07-69db-451e-9807-d8aa3b224398",
	_val.map()
		.set("colspan", 0)
		.set("description", "")
		.set("firebase", "")
		...
		.set("title", "Name")
		.set("type", "text")
		.set("uid", "0a224f64-062a-401b-9580-42838b3b2db3")
		.set("unique", true)
		.set("user_id", 0)
		.set("whenedit", true)
		.set("whenexport", true)
